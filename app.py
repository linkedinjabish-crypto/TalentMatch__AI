...
if not st.session_state.get('logged_in', False):
    ...
    with col_img:
        ...
        st.markdown("<h3 style='margin-top: 15px; font-size: 22px; text-align:center; font-weight: 700; color: #e2e8f0; animation: glowingPulse 3s infinite;'>TalentMatch AI is parsing resumes...<br><span style='color: #cbd5e1; font-weight: 400;'>Sit back and grab a coffee</span></h3>", unsafe_allow_html=True)
    ...
    with col_login:
        ...
        <div style='text-align:center; padding-bottom:12px;'>
            <div style='font-size:32px; font-weight:900; color:#ffffff; letter-spacing:-1px; margin-bottom: 2px;'>
                ...
                <span style='color:#a855f7; font-size:16px; font-weight:800; vertical-align: super; margin-left: 2px; opacity: 0.9;'>AI</span>
            </div>
        ...
        <div class='trust-row' style='margin-top: 10px; padding-top: 10px;'>
            ...
            <span class='trust-item'>🤖 AI-Powered</span>
...
def custom_ai_loading(message="TalentMatch AI is actively processing..."):
...
with col2:
    ...
    if st.button("⏻", help="Disconnect AI System / Logout"):
        st.session_state.logged_in = False
        st.rerun()
    st.markdown("</div>", unsafe_allow_html=True)
...
# ================= EVAL PAGE =================
    ...
    with _hcol_title:
        st.markdown("<h2 style='margin:0; padding:4px 0; font-size:26px; font-weight:800; color:#a855f7;'>AI Evaluation</h2>", unsafe_allow_html=True)
    ...
    with col_up:
        ...
        eval_btn = st.button("🚀 Run AI Matrix Evaluation", use_container_width=True)
...
# ================= AI QUESTIONS =================
    ...
    try:
        ...
        pass
    st.markdown("<h1 style='text-align:center; font-size: 36px; margin-bottom: 30px; font-weight: 800; color: #3b82f6;'>AI Interview Questions</h1>", unsafe_allow_html=True)
    ...
    with _hcol_back:
        if st.button("← Back", key="back_ai", use_container_width=True):
            st.session_state.page = "home"; st.rerun()
    with _hcol_title:
        st.markdown("<h2 style='margin:0; padding:4px 0; font-size:26px; font-weight:800; color:#3b82f6;'>AI Interview Questions</h2>", unsafe_allow_html=True)
